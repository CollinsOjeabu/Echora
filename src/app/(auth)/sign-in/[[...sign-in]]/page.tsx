      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="font-serif-display text-5xl text-cream leading-tight mb-6">
            Learn Loud.<br />
            <span className="text-ember italic">Post Smart.</span>
          </h1>
          <p className="text-cream-muted text-lg leading-relaxed">
            Your AI research assistant that learns from everything you read,
            watch, and save — then creates authentic content from your knowledge.
          </p>
        </div>
      </div>
