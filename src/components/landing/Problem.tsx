  ...
  return (
    <section id="problem" style={{ padding: "140px 24px", background: C.void }}>
      <div style={{ maxWidth: 740, margin: "0 auto" }}>
        ...
        <RevealDiv>
          <h2 style={{
            fontFamily: "'DM Serif Display',serif", fontSize: "clamp(36px,5vw,52px)", fontWeight: 400,
        ...
        <RevealDiv>
          <div style={{
            background: "rgba(255,107,53,0.06)", borderLeft: `2px solid ${C.ember}`,
        ...
        <RevealDiv>
          <p style={{
            ...
            Threadda closes that gap. Your research becomes your content.
          </p>
        </RevealDiv>
      </div>
    </section>
