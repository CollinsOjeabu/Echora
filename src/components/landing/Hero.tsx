...
const cards = [
  ...
  },
  {
    ...
    post: '"The gap nobody solved: your curated research and your published content live in completely separate worlds. Threadda closes that gap."',
  ...
  return (
    <section id="hero" style={{
      ...
      <p style={{
        ...
        Threadda turns the content you already consume into original thought leadership — by synthesising your saved research into posts that sound exactly like you.
      </p>
      ...
      <div style={{ position: "relative", width: "min(520px, 90vw)", height: 220, animation: "fadeUp 0.8s 0.45s ease both" }}>
        <div style={{
          position: "absolute", left: "50%", width: "min(520px,90vw)", borderRadius: 14, padding: "20px 22px",
        ...
        <div style={{
          ...
          <div style={{ opacity: fade ? 1 : 0, transition: "opacity 0.4s ease" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              <span style={{
                fontSize: 10, fontWeight: 500, background: "rgba(255,107,53,0.1)", color: C.ember,
            ...
            <p style={{
              ...
              color: "rgba(237,232,224,0.8)", lineHeight: 1.6, marginBottom: 14
            }}>{c.post}</p>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginTop: 10 }}>
              {c.sources.map(s => (
                <span key={s} style={{
                  fontSize: 9, fontFamily: "'JetBrains Mono',monospace", color: "rgba(237,232,224,0.4)",
